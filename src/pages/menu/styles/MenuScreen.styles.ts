...
export const s = StyleSheet.create({
  ...
  activeBannerText: { fontSize: 13, fontFamily: FONTS.semiBold, color: '#D44A00', flex: 1, marginLeft: 8 },
  activeBannerBtn: {
  ...
  searchRow: {
    ...
    backgroundColor: COLORS.white, paddingHorizontal: 16, paddingBottom: 14,
