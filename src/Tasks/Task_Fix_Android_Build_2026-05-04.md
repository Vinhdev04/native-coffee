...
- [ ] Bước 4: Xử lý triệt để luồng Đăng nhập/Đăng xuất (Login/Logout) với API.
- [ ] Bước 5: Hiển thị danh sách sản phẩm thực tế (Show Product) từ Service.
- [ ] Bước 6: Cập nhật giao diện Trang chủ (Update UI Homepage) theo thiết kế mới.
- [/] Bước 7: Kiểm tra và sửa lỗi Network Error/RSA Encryption khi Login.
